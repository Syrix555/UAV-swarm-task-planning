...
def create_hard_scenario() -> Battlefield:
    ...
    targets = [
        ...
        Target(id=4, x=72, y=30, value=8.0, required_uavs=1),
        ...
        Target(id=9, x=72, y=60, value=9.5, required_uavs=2),
        ...
        Target(id=13, x=74, y=84, value=8.5, required_uavs=1),
        ...
        Target(id=17, x=70, y=28, value=7.0, required_uavs=1),
        Target(id=18, x=72, y=38, value=8.0, required_uavs=1),
        Target(id=19, x=70, y=50, value=7.5, required_uavs=1),
        Target(id=20, x=72, y=70, value=8.5, required_uavs=1),
        Target(id=21, x=74, y=80, value=7.0, required_uavs=1),
        Target(id=22, x=72, y=94, value=9.0, required_uavs=1),
        ...
        Target(id=27, x=70, y=64, value=6.5, required_uavs=1),
    ]
