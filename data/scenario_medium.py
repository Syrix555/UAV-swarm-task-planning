...
def create_medium_scenario() -> Battlefield:
    ...
    targets = [
        Target(id=0, x=75, y=15, value=8.0),
        Target(id=1, x=80, y=25, value=10.0),
        Target(id=2, x=85, y=40, value=7.0),
        Target(id=3, x=70, y=50, value=9.0),
        Target(id=4, x=90, y=55, value=6.0),
        Target(id=5, x=75, y=65, value=8.5),
        Target(id=6, x=85, y=70, value=10.0),
        Target(id=7, x=80, y=80, value=7.5),
        Target(id=8, x=70, y=85, value=9.0),
        Target(id=9, x=90, y=95, value=6.5),
    ]
